...
Reads `.pi-rsg/trace.json` and auto-generates a human-readable
...
Usage:
    python build-traceability.py --pi-rsg-dir .pi-rsg --output-dir final
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--pi-rsg-dir", default=".pi-rsg")
    parser.add_argument(
        "--output-dir",
        default="final",
