...
Usage:
    python -m source_map_v2 --target ./src --output rds/analysis/<session_name>/source-map.json
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="pi-rsg source-map v2 (role-typed, framework-aware)")
