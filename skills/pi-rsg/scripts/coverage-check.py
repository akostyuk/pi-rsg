...
11. MECE check (consults `.pi-rsg/trace.json`, `--min-mece-coverage`)
...
def render_text(report: CoverageReport) -> str:
    lines: list[str] = []
    lines.append("=== pi-rsg Phase 4 verification report (v2) ===")
    lines.append("")
...
def main() -> int:
    ...
    p.add_argument("--pi-rsg-dir", type=Path, default=Path.cwd() / ".pi-rsg")
