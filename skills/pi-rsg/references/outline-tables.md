...
A catalogue of Layer 1 (always-fully-enumerated tables) used by pi-rsg's **outline mode**. For each language / framework, this document defines which abstractions to list as tables and which ripgrep patterns enumerate them exhaustively.
