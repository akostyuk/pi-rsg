...
When the user wants to add their own checks, create `rds/analysis/<session_name>/custom-checklists.md` and append items there. In Phase 4, the agent runs the custom checks in addition to the standard ones.
