...
### v1 support range
The initial release does not support adding custom categories through a UI. Users can add them by editing `rds/analysis/<session_name>/questions.json` manually.

### Manual procedure

1. Create `rds/analysis/<session_name>/custom-categories.json`:
     ...
     "categories": [
       {
         ...
         "label_ru": "Тюнинг производительности",
